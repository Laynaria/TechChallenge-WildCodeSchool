...
var timeCounted = function timeCounted() {
  if (timeCounter > 0) {
    timeCounter--;
...
clickerChest.addEventListener("click", function (e) {
  ...
  if (timeCounter >= 0) {
    ...
    var goldRandom = Math.random() * 150;
    ...
    goldCoin.style.setProperty("--left", Math.random() * 60 * plusMinus + 20 + "%");
    setTimeout(function () {
      goldCoin.remove();
    }, 1300);
    Counter++;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","treasure.js"], null)
//# sourceMappingURL=/treasure.ddac1007.js.map